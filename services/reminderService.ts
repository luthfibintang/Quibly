...
//Task name untuk background fetch - REMOVED (deprecated)
...
export const checkAndProcessReminders = async (): Promise<void> => {
  try {
    ...
    const dueReminders = reminders.filter(reminder => {
      ...
      // Toleransi: dari 15 detik sebelum sampai 30 detik setelah waktu yang ditentukan
      const isDue = timeDiff >= -5000 && timeDiff <= 10000;
